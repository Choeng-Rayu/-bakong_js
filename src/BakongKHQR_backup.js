...
class BakongKHQR {
    ...
    amount(value) {
        ...
        this.validateLength(amountStr, EMV.INVALID_LENGTH_TRANSACTION_AMOUNT, 'Amount');
        return this.formatValue(EMV.TRANSACTION_AMOUNT, amountStr);
    }
    ...
    async checkPayment(md5) {
        ...
        try {
            ...
            console.log(`[DEBUG] Bakong API error:`, error.message);
            return 'UNPAID';
        }
    }
